<?php  
      ...
      if (isset($_GET['aksi']) && isset($_GET['id'])) {
        ...
        if ($_GET['aksi'] == 'edit') {
            header("location:?p=user_edit&id=$id");
        } else if ($_GET['aksi'] == 'hapus') {
            header("location:?p=user_hapus&id=$id");
        } 
    }
	...
	<div class="row">
		<div class="col-sm-12">
			 <div class="box box-primary">
               ...
               <div class="row">
                    <div class="col-md-2">
                        <a href="index.php?p=user_tambah" class=" btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a> 
                    </div>
                    <br><br>
                </div>                  
