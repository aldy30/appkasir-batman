  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?p=transaksi_tambah"><i class="fa fa-retweet"></i> <span>Input Transaksi</span></a></li>
        <li><a href="index.php?p=transaksi"><i class="fa fa-users"></i> <span>Data Transaksi</span></a></li>
